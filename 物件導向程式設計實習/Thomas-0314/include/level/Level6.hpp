//
// Created by Thomas on 2025/5/14.
//
...
public:
    ...
    void Load(GameContext& ctx) override {
        ...
        spawner.Spawn({ ZombieSpawner::Type::Regular,     1, 620, 200, 3 });
        spawner.Spawn({ ZombieSpawner::Type::Regular,     1, 720, 100, 1 });
        spawner.Spawn({ ZombieSpawner::Type::Conehead,     1, 800, 100, 5 });
        spawner.Spawn({ ZombieSpawner::Type::Conehead,     1, 880, 100, 2 });
        spawner.Spawn({ ZombieSpawner::Type::Polevaulter,     1, 960, 250, 4 });
        spawner.Spawn({ ZombieSpawner::Type::Conehead,     1, 1000, 100, 3 });
        spawner.Spawn({ ZombieSpawner::Type::Regular,     1, 1000, 100, 5 });
        spawner.Spawn({ ZombieSpawner::Type::Regular,     1, 1120, 100, 1 });
        spawner.Spawn({ ZombieSpawner::Type::Regular,     1, 1120, 100, 2 });
        spawner.Spawn({ ZombieSpawner::Type::Regular,     1, 1120, 100, 4 });
        spawner.Spawn({ ZombieSpawner::Type::Regular,     1, 1200, 100, 2 });
        spawner.Spawn({ ZombieSpawner::Type::Regular,     1, 1200, 100, 3 });
        spawner.Spawn({ ZombieSpawner::Type::Regular,     2, 1200, 50, 5 });
    }
    ...
    void GameUpdate(GameContext& ctx)override {
        ...
        if (!finalWaveSpawned && AllZombiesDead(ctx.zombies)) {
            ...
            spawner.Spawn({ZombieSpawner::Type::Conehead,1,570,30,1});
            spawner.Spawn({ZombieSpawner::Type::Regular,1,600,0,1});
            spawner.Spawn({ZombieSpawner::Type::Regular,1,570,50,2});
            spawner.Spawn({ZombieSpawner::Type::Regular,1,570,50,3});
            spawner.Spawn({ZombieSpawner::Type::Polevaulter,1,550,0,4});
            spawner.Spawn({ZombieSpawner::Type::Regular,1,570,50,4});
            spawner.Spawn({ZombieSpawner::Type::Conehead,1,570,50,5});
